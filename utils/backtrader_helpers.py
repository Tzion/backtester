...
def convert_to_dataframe(feed: bt.DataBase, time='datetime', columns=['open', 'high', 'low', 'close', 'volume']) -> pandas.DataFrame:
    # TODO generelize (all the specific variables)
    ...
    time_line = feed.lines.__getattribute__(time)
