...
app.layout = html.Div(children=[
    ...
    html.Div(children=[
        ...
        dcc.Interval(id='trade-list-interval', interval=100000, n_intervals=0)
        ]
    ),
    html.Div(children=[
        html.H2('Observers'),
        ...
        # html.Iframe(id='graph', src=app.get_asset_url(os.listdir(TRADES_DIR)[0]), width='100%', height='800px'),
    ]),
])
