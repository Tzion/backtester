...
def main():
    ...
    add_data(random=True,start_date=datetime(2018,4,4), end_date=datetime(2020, 3, 11), limit=88, dirpath='data_feeds')
    # add_data(start_date=datetime(2018,4,4), end_date=datetime(2020, 3, 11), stock_names=['DAL.csv', 'PNW.csv', 'AMP.csv'],limit=0, dirpath='data_feeds')
    # add_strategies(Top3)
    ...
    # plot(strategies[0], limit=7, only_trades=True, plot_observers=False, interactive_plots=True)
